...
/*****************
 * iSimplex ************************** Layer 1 - POST Operators: Functions to Change
 * values * * Use this source-code to add url functions to * change values like
 * "newOffset" or "newValue" * * *
 * 
...
public class PostOperators {
     ...
     * 
     * @param id Device ID value Value in POST Message
    ...
    /**
     * /modify/Device Id/newState fanspeed: 15, 50 or 85 <=> slow, med or fast mode: 0 =
     * cold, 1 = hot/. onoff: 0 or 1 swing: 0 or 1 temperature: 16 to 30
     */
    public static boolean newState(
            int id,
                int onoff,
                int temperature,
                int fanspeed,
        ...
        String value = "onoff=" + onoff + "&temperature=" + temperature + "&fanspeed="
                + fanspeed + "&mode=" + mode + "&swing=" + swing;
