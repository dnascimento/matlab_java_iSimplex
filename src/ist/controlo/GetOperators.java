...
/*****************
 * iSimplex ************************** Layer 1 - GET Operators: Functions to Change values
 * * * Use this source-code to add url functions to * read values * * *
 * 
    ...
    public static Map<String, String> readDevice(String json, Integer id) {
        ...
        for (JsonElement object : deviceObjectArray) {
            ...
            for (int i = 0; i < deviceProperties.size(); i++) {
                ...
                String device_id = jsoProp.get("device_id").toString().replace("\"", ""); // delete
                                                                                          // ""
                                                                                          // element;
